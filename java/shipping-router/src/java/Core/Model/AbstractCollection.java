...
import Core.Filter.FilterResultsInterface;
import Core.Model.Generate.RegenerateInterface;
 ...
 * @param <E>
 */
public abstract class AbstractCollection<E extends AbstractModel> extends ObjectStandard implements Iterable<E>
{
